...
- track and model your device context (GPS data & speed & acceleration & time of day) when making these calls, so that later can be recognized and triggered autonomously
