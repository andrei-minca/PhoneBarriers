...
class AppPreferences(val context: Context) {
    ...
    companion object {
        ...
        private const val KEY_WIDGET_BARRIER_ID = "widget_barrier_id"
    ...
    fun getWidgetBarrierColor(): Int = sharedPrefs.getInt(
        ...
        androidx.core.content.ContextCompat.getColor(context, ro.andi.phonebarriers.R.color.gray_no_barrier_in_sight)
    )
